...
--
-- Servidor: localhost
-- Tiempo de generación: 20-06-2014 a las 15:03:05
...
(1, NULL, 'NULL', NULL, 'controllers', 1, 376),
...
(14, '2014-06-01', '2014-07-01', 30, 1600.00, 22),
(15, '2014-06-01', '2014-07-01', 30, 400.00, 23);
...
--
-- Volcado de datos para la tabla `pagodeprestamo`
--

INSERT INTO `pagodeprestamo` (`id`, `montopagado`, `fecha`, `nroreferencia`, `diaspagados`, `montodeuda`, `tipopago_id`, `descri`, `descuento`, `user_id`, `prestamo_id`) VALUES
(1, 28800, '2014-06-19', '', 18, 0, 5, 'para los 18 dias atrasados de la deuda', NULL, 17, 22),
(2, 7200, '2014-06-19', '', 18, 0, 5, 'pago de 18 dias que debe', NULL, 17, 23),
(3, 400, '2014-06-20', '', 18, 0, 5, 'pago de 18 dias que debe', NULL, 17, 23),
(4, 400, '2014-06-20', '', 18, 0, 5, 'pago de 18 dias que debe', NULL, 17, 23),
(5, 400, '2014-06-20', '', 18, 0, 4, '', NULL, 17, 23);
...
(22, 3, 40000, '2014-07-01', '2014-06-01', 48000, 5, 30, 0, NULL, 17),
(23, 3, 10000, '2014-07-01', '2014-06-01', 4800, 5, 30, 18, NULL, 17);
...
CREATE TABLE IF NOT EXISTS `transaccionprestamointeres` (
  ...
  `montodeuda` float NOT NULL,
  `pagodeprestamo_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `transaccionprestamointeres` (`id`, `prestamo_id`, `montointeres`, `fecha`, `montodeuda`, `pagodeprestamo_id`) VALUES
(1, 23, 7200, '2014-06-19', 4800, 2);
...
ALTER TABLE `pagodeprestamo`
  ...
  ADD CONSTRAINT `fk_pagodeprestamo_prestamo1` FOREIGN KEY (`prestamo_id`) REFERENCES `prestamo` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
