...
<?php echo $this->Form->create('Garantia'); ?>
	<fieldset>
		<legend><?php echo __('Edit Garantia'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Garantia.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Garantia.id'))); ?></li>
